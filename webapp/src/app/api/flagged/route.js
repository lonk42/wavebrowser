// Returns every AI-flagged ("interesting") recording across all days, newest-first.
// Same normalized item shape as the day route (/api) so RecordingCard and the player
